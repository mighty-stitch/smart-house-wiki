...
<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="/img/LT-dimmer_Module.jpeg" alt="Dimmer Module" style={{borderRadius: '8px', maxWidth: '100%'}} />
  <p><i>This picture corresponds to Dimmer Module 8, located in the bottom right box.</i></p>
</div>

<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="/img/relay_bottom_left.jpeg" alt="Relays Bottom Left" style={{borderRadius: '8px', maxWidth: '100%'}} />
  <p><i>View of the Relay Modules located in the bottom-left quadrant box.</i></p>
</div>

<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="/img/relay_upper_right.jpeg" alt="Relays Upper Left" style={{borderRadius: '8px', maxWidth: '100%'}} />
  <p><i>Upper-right quadrant containing Dimmer Modules 4.2 through 7</i></p>
</div>

<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="/img/relay_bottom_right.jpeg" alt="Relays Bottom Right" style={{borderRadius: '8px', maxWidth: '100%'}} />
  <p><i>Bottom-right quadrant featuring Dimmer Modules 8-11.</i></p>
</div>

<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="/img/PW_brain.jpeg" alt="Power Supply" style={{borderRadius: '8px', maxWidth: '100%'}} />
